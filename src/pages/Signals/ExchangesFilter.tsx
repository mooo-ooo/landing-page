...
export default function ExchangesFilter<Value>(
  ...
  const {
    ...
    getOptionProps,
    groupedOptions,
    value, // This is the internal state from useAutocomplete
    focused,
    setAnchorEl,
  } = useAutocomplete({
    multiple: true,
  ...
  // CRITICAL: Sync the internal hook state back to your SignalsContainer state
  useEffect(() => {
      ...
      <div {...getRootProps()}>
        ...
        <InputWrapper ref={setAnchorEl} className={focused ? 'focused' : ''}>
          {value.map((option, index) => {
            ...
            return (
              <StyledItem key={key} {...itemProps} label={props.getOptionLabel!(option)} />
            );
          })}
          <input {...getInputProps()} />
        </InputWrapper>
